...
/*
 * import java.util.*; import java.lang.*; import java.io.*; class GFG { public
 * static void main (String[] args) { Scanner sc=new Scanner(System.in); int
 ...
 * } int k=sc.nextInt();
 * 
 * System.out.print(kthSmallest(arr,k)); } public static int kthSmallest(int
 * arr[] ,int k) {
 * 
 * Arrays.sort(arr);
 * 
